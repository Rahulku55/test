    ...
    >
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img src="img/about-us.jpeg" class="d-block w-100 banner" alt="..." />
        </div>
        <div class="carousel-item">
          <img src="img/img1.jpeg" class="d-block w-100 banner" alt="..." />
          <!-- <img
        ...
        <div class="carousel-item">
          <img src="img/about.jpg" class="d-block w-100 banner" alt="..." />
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-12 col-lg-6">
            <div class="content">
              <h1>Our Mission</h1>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio ullam atque nihil veniam explicabo rerum quasi distinctio accusantium reiciendis quae,
                 impedit, incidunt suscipit iure repellat dolore natus autem repellendus soluta?
              </p>
            </div>
          </div>
          <div class="col-12 col-lg-6">
            <div>
              <img src="img/banner2.jpg" alt="" class="content-img" />
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="content">
              ...
              <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing
                 elit. Eligendi praesentium tempora reiciendis natus
                  neque nulla architecto eius vitae, minus quaerat placeat quas libero? Aliquid, 
                  eum natus? Est, ipsam rem. Quidem.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row py-4">
          ...
          <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-2">
                <a href="#" class="footer-link">Pric list</a>
              </li>
              <li class="mb-2"><a href="#" class="footer-link">Pravicy & policy</a></li>
              <li class="mb-2"><a href="#" class="footer-link">Term & Condation</a></li>
            </ul>
          </div>
          <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li class="mb-2"><a href="#" class="footer-link">Mobile : 9999999999</a></li>
              <li class="mb-2">
